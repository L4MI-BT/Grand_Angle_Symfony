...
{
    #[Route(name: 'app_admin_etape_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_admin_etape_new', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_admin_etape_show', methods: ['GET'])]
    public function show(Etape $etape): Response
    {
        return $this->render('admin/etape/show.html.twig', [
            'etape' => $etape,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_admin_etape_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_admin_etape_delete', methods: ['POST'])]
