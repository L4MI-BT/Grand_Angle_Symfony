...
{
    #[Route(name: 'app_admin_fonction_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_admin_fonction_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_admin_fonction_index', [], Response::HTTP_SEE_OTHER);
        }
    ...
    #[Route('/{id}', name: 'app_admin_fonction_show', methods: ['GET'])]
    ...
    #[Route('/{id}/edit', name: 'app_admin_fonction_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id}', name: 'app_admin_fonction_delete', methods: ['POST'])]
